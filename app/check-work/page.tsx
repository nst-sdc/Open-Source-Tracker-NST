          ...
          {authenticated === null ? (
            ...
            <div className="space-y-6">
              ...
              <a
                ...
                className="w-full bg-brand-500 hover:bg-brand-600 text-white font-[550] h-12 rounded-[11px] transition-colors shadow-brand-btn flex items-center justify-center gap-2.5 cursor-pointer text-sm"
              >
