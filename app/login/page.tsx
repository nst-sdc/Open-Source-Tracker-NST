  ...
  return (
    <main className="min-h-screen bg-panel flex flex-col items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        {/* Login Card */}
        <div className="bg-white border border-line rounded-2xl shadow-card p-8">
          ...
          <Link
            ...
            prefetch={false}
            className="w-full flex items-center justify-center gap-2.5 bg-brand-500 hover:bg-brand-600 text-white font-[550] h-12 rounded-[11px] transition-colors shadow-brand-btn cursor-pointer"
          >
